...
import com.platzi.platzi.market.domain.service.PlatziUserDetailService;
import com.platzi.platzi.market.web.security.JWTUtil;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request){
        try {
            ...
            UserDetails userDetails = platziUserDetailService.loadUserByUsername(request.getUser());
